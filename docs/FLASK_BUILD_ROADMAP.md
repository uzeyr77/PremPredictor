...
**See also:** [ROUTING_AND_FRONTEND_GUIDE.md](ROUTING_AND_FRONTEND_GUIDE.md) — Flask routing basics, step-by-step route wiring, and frontend (Jinja + `fetch`) checklist for this repo.
