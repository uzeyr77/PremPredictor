...
**After this gate:** Use [ROUTING_AND_FRONTEND_GUIDE.md](ROUTING_AND_FRONTEND_GUIDE.md) to wire blueprints to `PredictionService`, fix `url_for` in templates, and ship pages + JSON APIs.
